...
export class UserMigration1635068590931 implements MigrationInterface {
    name = 'UserMigration1635068590931'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "temporary_user" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "name" varchar NOT NULL, "email" varchar NOT NULL, "favorite" varchar NOT NULL)`);
